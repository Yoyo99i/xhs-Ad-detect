...
function buildPrompt(noteText) {
  return [
    ...
    "",
    "## 给普通用户的提醒",
    "面向看到这份报告的普通读者。语气像朋友吐槽，不像官方公告。要求：",
    "1. 直接从笔记里挑 1-3 句最具代表性的营销话术，用引号包起来作为'罪证'（例如\"闭眼冲\"\"全网最低\"\"敷完立刻有效果\"）；",
    "2. 紧接着用口语化的转折词拆穿：「这类话术听听就好」「这种效果承诺无科学依据」；",
    "3. 如果命中多个维度，用加粗短词分点（例如**只夸不贬**、**效果说得太满**、**发誓式保证**），每点一行；",
    "4. 给一句科普解释：护肤品效果因人而异、速效美白往往缺乏科学依据、好产品不需要靠禁词和焦虑感推销；",
    "5. 结尾给 1-2 条具体可执行的建议：多看真实多角度测评（包括差评）、参考其他博主（尤其标注合作/广告的）、晒后修护严重时就医、勿被焦虑营销裹挟冲动囤货；",
    "6. 总字数 80-180 字。可以用「带偏」「裹挟」「听听就好」这类活人感强的词；",
    "7. 禁止写'本结果由AI生成'等免责声明（页面底部已有）。",
    "",
    "【笔记正文】",
    noteText
  ].join("\n");
